...
pseq :: [Parser] -> Parser
pseq = pcombine pseq pcseq

pand :: [Parser] -> Parser
pand = pcombine pand pcjnc

por :: [Parser] -> Parser
por = pcombine por pcdjnc
...
json = por [object, array, value (PEOF PFail)]
